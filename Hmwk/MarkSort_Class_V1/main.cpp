 ...
 * Purpose:  Example of Mark Sort with Structures
 */
...
//User Libraries
class Array{
    //Have to specify since classes default to private -> ILLEGAL
    //It is possible, but not Recommended
    //This is bad programming practice. Do NOT do in class. Or ever.
    public:
